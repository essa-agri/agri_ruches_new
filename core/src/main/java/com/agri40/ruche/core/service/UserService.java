...
import com.agri40.ruche.core.config.Constants;
import com.agri40.ruche.core.domain.Authority;
import com.agri40.ruche.core.domain.User;
import com.agri40.ruche.core.repository.AuthorityRepository;
import com.agri40.ruche.core.repository.UserRepository;
import com.agri40.ruche.core.security.AuthoritiesConstants;
import com.agri40.ruche.core.security.SecurityUtils;
import com.agri40.ruche.core.service.dto.AdminUserDTO;
import com.agri40.ruche.core.service.dto.UserDTO;
import java.time.Instant;
import java.time.temporal.ChronoUnit;
import java.util.*;

import com.agri40.ruche.core.web.rest.AuthenticateController;
...
public class UserService {
    ...
    public UserService(UserRepository userRepository, PasswordEncoder passwordEncoder, AuthorityRepository authorityRepository ,AuthenticateController authenticateController) {
        ...
        return userRepository
            ...
            .then(
                Mono.fromCallable(() -> {
                    ...
                    //newUser.setLogin(userDTO.getUserName().toLowerCase()); //update
                    ...
                    newUser.setDateOfBrith(userDTO.getDateOfBrith());
    ...
    public Mono<User> createUser(AdminUserDTO userDTO) {
        User user = new User();
        user.setLogin(userDTO.getUsername().toLowerCase()); // update
     ...
     */
    public Mono<AuthenticateController.JWTToken> updateUser(String firstName, String lastName, String email, String langKey, String imageUrl ,String username ,String phoneNumber ,Date dateOfBrith) {
        return SecurityUtils
            ...
            .flatMap(user -> {
                ...
                user.setLogin(username); // login == username
